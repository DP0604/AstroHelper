...
final_best = ah.Final_Best(data_arr, obs_date=selected_date, Lon=Lon, Lat=Lat, ele=ele, timezone=timezone, min_frac=0.08,Galaxies= 1,Nebulae=1) # Example function call to get the best objects
ah.PlotBestObjects(objects=data_arr, obs_date=selected_date, Lon=Lon, Lat=Lat, ele=ele, timezone=timezone, min_frac=0.08, k = 5 , Galaxies = 1, Nebulae= 1) # Example function call to plot the best objects